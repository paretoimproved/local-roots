...
| Pickup location | Brandon's house, 123 Example St, Portland, OR 97201 |
| Seller account | admin@example.com |
...
2. **⏸ PAUSE** — Human must log in as `admin@example.com` (password or Google OAuth).
